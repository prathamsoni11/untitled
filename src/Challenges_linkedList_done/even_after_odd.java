...
public class even_after_odd {
    ...
    // name at even_after_odd is equal to LinkedList
    public even_after_odd() {
        this.head = null;
        this.tail = null;
        this.size = 0;
    }

    public even_after_odd(Node head, Node tail, int size) {
        this.head = head;
        this.tail = tail;
        this.size = size;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        even_after_odd list = new even_after_odd();
